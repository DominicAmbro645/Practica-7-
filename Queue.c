 ...
 *
 * @return false si se agot� la memoria y el valor no se pudo insertar. true en
 * caso contrario.
 */
 ...
 *
 * @param this Referencia a un objeto Queue.
 * @param value Recept�culo para el valor extra�do.
 *
 * @return false si la cola est� vac�a. true en caso contrario.
 */
 ...
 *
 * @param this Referencia a un objeto Queue.
 * @param value Recept�culo para el valor observado.
 *
 * @return false si la cola est� vac�a. true en caso contrario.
 */
...
/**
 * @brief Indica si la cola est� vac�a o no.
 *
 * @param this Referencia a un objeto Queue.
 *
...
/**
 * @brief Indica el n�mero de elementos actuales en la cola.
 *
 * @param this Referencia a un objeto Queue.
 *
 * @return El n�mero de elementos actualmente en la cola.
 */
